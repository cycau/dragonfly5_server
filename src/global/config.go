...
type Config struct {
	...
	StreamingResponseMode bool               `yaml:"streamingResponseMode"`
...
func (l *Logger) Debug(msg string, args ...any) {
	slog.Debug(l.traceId, append([]any{"spot", msg}, args...)...)
}
func (l *Logger) Info(msg string, args ...any) {
	slog.Info(l.traceId, append([]any{"spot", msg}, args...)...)
}
func (l *Logger) Warn(msg string, args ...any) {
	slog.Warn(l.traceId, append([]any{"spot", msg}, args...)...)
}
func (l *Logger) Error(msg string, args ...any) {
	slog.Error(l.traceId, append([]any{"spot", msg}, args...)...)
}
